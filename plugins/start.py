...
async def start(client, message):
    ...
    button=InlineKeyboardMarkup([[
        InlineKeyboardButton(" Developer ", url='https://t.me/Kali_Botz_Bot')
        ],[
        InlineKeyboardButton(' Updates', url='https://t.me/Kali_Botz'),
        InlineKeyboardButton(' Support', url='https://t.me/Kali_Botz_Support')
        ],[
        InlineKeyboardButton(' About', callback_data='about'),
        InlineKeyboardButton(' Help', callback_data='help')
        ],[
        InlineKeyboardButton(" Join Our Movie Channel !", url='https://t.me/TamilRockerz_TR')
        ]
        ])
    if START_PIC:
